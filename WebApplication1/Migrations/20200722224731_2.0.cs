    ...
    public partial class _20 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HouseEnergyMeterId = table.Column<int>(nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PoleEnergyMeterId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SerialId = table.Column<string>(nullable: true),
                    UserId = table.Column<string>(nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MeterOfPoleEnergyMeterId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MeterId = table.Column<string>(nullable: true),
                    PoleEnergyMeterId = table.Column<string>(nullable: true),
                    PoleEnergyMeterId1 = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
